...
import { INDICATORS_HUB, hubMetadata } from '@/lib/seo-hubs'

export const metadata = hubMetadata(INDICATORS_HUB)

export default function TradingViewIndicatorsHubPage() {
  const hub = INDICATORS_HUB
  return (
    <SeoHubPage
      path={hub.path}
      title={hub.title}
