...
export default function PropFirmCard({ firm }: { firm: PropFirmCardData }) {
    ...
    return (
        <div
            className="relative flex flex-col bg-[#FFFFFF08] border border-[#FFFFFF0D] rounded-[50px] overflow-hidden transition-colors duration-300"
        ...
        >
            ...
            <div className="relative z-10 flex items-start justify-between gap-3 pt-10 px-10 pb-[50px] border-b border-[#FFFFFF1A]">
                ...
                {mostPopular && (
                    <div className="flex items-center justify-center bg-[#88C4FF] border border-dashed border-white text-black text-[14px] leading-[15px] font-semibold px-6 h-[43px] rounded-[60px] flex-shrink-0">
                        Most Popular
                    </div>
                )}
            </div>
