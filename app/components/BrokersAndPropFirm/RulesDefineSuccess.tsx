...
const RulesDefineSuccess = () => {
    return (
        <div className='px-4 sm:px-6 pb-[65px]'>
            <div className='relative max-w-[1560px] overflow-hidden mx-auto w-full flex items-center justify-between border border-[#FFFFFF0D] bg-[#FFFFFF05] rounded-[80px] px-[65px] py-[77.55px]'>
                {/* Shadow */}
                <div
                    aria-hidden="true"
                ...
                <div className='w-[300px] h-[350px] absolute top-0 right-0'>
                    <div
                        className="absolute inset-0 opacity-60 bg-[url('/assets/card-dot-img.svg')] bg-cover"
                        style={{ backgroundSize: "250%", }}
                    />
                </div>

                {/* Left */}
                <div className="flex-shrink-0 w-full xl:max-w-[665px] relative z-10">
                    ...
                    <p className="my-7 text-white/80 text-[16px] sm:text-[20px] leading-[22px] sm:leading-[30px] font-semibold max-w-[611px]">
                    ...
                    <ul className='mb-8 flex flex-col gap-5'>
                        {[
                            ...
                            <li key={i} className='flex items-center gap-3'>
                                ...
                                <span className='text-white text-[16px] sm:text-[20px] leading-[24px] font-normal'>
                                    {item.prefix}
