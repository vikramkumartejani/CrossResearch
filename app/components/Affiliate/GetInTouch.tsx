        ...
        <div className='px-4 sm:px-6'>
            <div className='max-w-[1697px] mx-auto'>
                <div className='flex items-center lg:flex-row flex-col justify-between gap-6'>
                    ...
                    {/* Right - Form */}
                    <div className='w-full lg:max-w-[1019px] lg:min-w-[650px] border border-[#FFFFFF0D] bg-[#FFFFFF08] rounded-[24px] sm:rounded-[40px] lg:rounded-[60px] p-4 sm:p-8 xl:p-10'>
                        <div className='bg-[#FFFFFF05] border border-[#FFFFFF1A] rounded-[20px] sm:rounded-[40px] lg:backdrop-blur-[40px] p-5 sm:p-8 xl:p-10'>
                            <h2 className='text-white text-[20px] sm:text-[28px] leading-7 sm:leading-9 font-normal mb-2'>Partner Application</h2>
                            ...
                            <form className='flex flex-col gap-3.5 sm:gap-4'>
                                ...
                                <div className='grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4'>
                                    <div className='flex flex-col gap-2 sm:gap-3'>
                                        ...
                                        <input
                                            ...
                                            className='w-full bg-[#FFFFFF05] border border-[#FFFFFF0D] rounded-lg sm:rounded-[16px] px-3.5 sm:px-5 h-[44px] sm:h-[61px] text-white text-[14px] sm:text-[16px] placeholder:text-white/50 outline-none'
                                            />
                                    </div>
                                    <div className='flex flex-col gap-2 sm:gap-3'>
                                        <label className='text-white text-[14px] sm:text-[16px] font-normal leading-5 sm:leading-[21px]'>Email Address</label>
                                        <input
                                            type="email"
                                ...
                                <div className='grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4'>
                                    ...
                                    <div className='flex flex-col gap-2 sm:gap-3'>
                                        <label className='text-white text-[14px] sm:text-[16px] font-normal leading-5 sm:leading-[21px]'>Audience Size</label>
                                        <CustomSelect
                                ...
                                <div className='grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4'>
                                    ...
                                    <div className='flex flex-col gap-2 sm:gap-3'>
                                        <label className='text-white text-[14px] sm:text-[16px] font-normal leading-5 sm:leading-[21px]'>Primary Market Focus</label>
                                        <CustomSelect
                                ...
                                <div className='flex flex-col gap-2 sm:gap-3'>
                                    ...
                                    <textarea
                                        ...
                                        rows={5}
                                        className='w-full bg-[#FFFFFF05] border border-[#FFFFFF0D] rounded-lg sm:rounded-[16px] p-3.5 sm:p-5 h-[194px] text-white text-[14px] sm:text-[16px] placeholder:text-white/50 outline-none'
                                    />
                                </div>
                                ...
                                <button
                                    type="submit"
                                    className='w-full bg-white text-[#070711] text-[14px] sm:text-[15px] font-semibold h-[48px] sm:h-[60px] rounded-full hover:bg-white/90 transition-colors cursor-pointer mt-3'
                                >
                                    Submit Application
                                </button>
                            </form>
