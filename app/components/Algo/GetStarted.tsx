                ...
                <div className="flex items-center justify-between gap-6 items-center">
                    ...
                    <div className='max-w-[573px]'>
                        ...
                        <h3 className="mb-4 text-left font-normal text-3xl sm:text-4xl md:text-5xl xl:text-[54px] leading-tight xl:leading-[70px] bg-[linear-gradient(176.19deg,#B1D8FF_-8.19%,#FFFFFF_107.43%)] bg-clip-text text-transparent">
                            Choose your plan that<br />fits your needs
                        </h3>
                    ...
                    <div className="relative w-full max-w-[751px] z-10 bg-[#FFFFFF08] border border-[#FFFFFF0D] rounded-[24px] sm:rounded-[40px] py-[41px] overflow-hidden">
                        <Image
