...
function CheckIcon() {
    return (
        <svg className='min-w-5 h-5 xl:min-w-[28px] xl:h-[28px]' viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <div className="px-4 sm:px-6 pt-16 sm:pt-24 lg:pt-32">
            <div className="max-w-[1560px] mx-auto flex flex-col gap-10 sm:gap-14 lg:gap-20">
                ...
                {/* Card 2 — Divergence */}
                <div className='border border-[#FFFFFF0D] bg-[#FFFFFF05] p-6 sm:p-10 lg:pl-[88px] lg:pr-[63px] lg:pt-[42px] lg:pb-[41px] rounded-[30px] sm:rounded-[40px] lg:rounded-[80px] flex flex-col-reverse lg:flex-row justify-between gap-8 lg:gap-6 items-center'>
                    <div className="relative w-full lg:max-w-[699px] rounded-[20px] sm:rounded-[28px] overflow-hidden p-4 sm:p-5 border border-[#FFFFFF14] flex-shrink-0">
                ...
                {/* Card 3 — Volatility */}
                <div className='border border-[#FFFFFF0D] bg-[#FFFFFF05] p-6 sm:p-10 lg:pl-[90px] lg:pr-[74px] lg:py-[70px] rounded-[30px] sm:rounded-[40px] lg:rounded-[80px] flex flex-col lg:flex-row justify-between gap-8 lg:gap-6 items-center'>
                    ...
                    <div className="relative w-full lg:max-w-[712px] rounded-[20px] sm:rounded-[30px] max-h-[636px] overflow-hidden flex-shrink-0">
                ...
                <div className='border border-[#FFFFFF0D] bg-[#FFFFFF05] p-6 sm:p-10 lg:pl-[88px] lg:pr-[63px] lg:py-[32px] rounded-[30px] sm:rounded-[40px] lg:rounded-[80px] flex flex-col-reverse lg:flex-row justify-between gap-8 lg:gap-6 items-center'>
                    <div className="relative w-full lg:max-w-[699px] max-h-[712px] rounded-[20px] overflow-hidden p-4 sm:p-5 border border-[#FFFFFF14] flex-shrink-0">
