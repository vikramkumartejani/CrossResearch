    ...
    return (
        <div className="px-4 sm:px-6 pt-16 sm:pt-24 lg:pt-32">
            <div className="max-w-[1560px] mx-auto flex flex-col gap-10 sm:gap-14 lg:gap-20">
                ...
                {/* Card 1 — NFP */}
                <div className='border border-[#FFFFFF0D] bg-[#FFFFFF05] px-6 sm:px-10 lg:pl-[90px] lg:pr-[74px] py-[70px] rounded-[40px] lg:rounded-[80px] flex flex-col lg:flex-row justify-between gap-8 lg:gap-6 items-center'>
                    <div className="flex flex-col max-w-full lg:max-w-[615px] w-full">
                        <div className="mb-5 w-fit bg-[#88C4FF1A] text-[#88C4FF] inline-flex items-center gap-2 pl-3.5 pr-[16px] py-[9px] rounded-[100px] text-[14px] sm:text-[18px] leading-5 sm:leading-[22px] font-normal font-inter">
                        ...
                        <h2 className="max-w-[615px] text-left font-normal text-3xl sm:text-4xl md:text-5xl xl:text-[54px] leading-tight xl:leading-[59px] bg-[linear-gradient(176.19deg,#B1D8FF_-8.19%,#FFFFFF_107.43%)] bg-clip-text text-transparent">{s0.title}</h2>
                        <p className="text-white/80 text-[15px] sm:text-[20px] leading-[30px] font-semibold my-5">{s0.subtitle}</p>
                        {s0.description && <p className="text-white/60 text-[14px] sm:text-[18px] leading-[22px] sm:leading-[27px] font-normal mb-5">{s0.description}</p>}
                        <div className="flex flex-col gap-5 mb-8">
                            {s0.points.map((point, i) => (
                                <div key={i} className="flex items-center gap-3">
                                    <CheckIcon /><span className="text-white/60 text-[14px] sm:text-[18px] leading-[27px]">{point.text}</span>
                                </div>
                            ))}
                        </div>
                        <button className="w-fit bg-white text-black text-[18px] sm:text-[20px] leading-6 font-semibold px-5 h-[48px] sm:h-[52px] rounded-[16px] hover:bg-white/90 transition-colors cursor-pointer inline-flex items-center gap-2.5">
                            {s0.ctaText}
                    ...
                    <div className="relative w-full lg:max-w-[715px] rounded-[20px] overflow-hidden flex-shrink-0 max-h-[636px]">
                        <Image src={s0.image} alt={s0.imageAlt} width={s0.imageWidth} height={s0.imageHeight} className="w-full h-auto object-cover" />
                    </div>
                </div>

                {/* Card 2 — Divergence */}
                <div className='border border-[#FFFFFF0D] bg-[#FFFFFF05] px-6 sm:px-10 lg:pl-[88px] lg:pr-[63px] pt-[42px] pb-[41px] rounded-[40px] lg:rounded-[80px] flex flex-col lg:flex-row justify-between gap-8 lg:gap-6 items-center'>
                    <div className="relative w-full lg:max-w-[699px] rounded-[20px] sm:rounded-[28px] overflow-hidden p-5 border border-[#FFFFFF14] flex-shrink-0">
                    ...
                    <div className="flex flex-col max-w-full lg:max-w-[615px] w-full">
                        ...
                        <h2 className="max-w-[615px] text-left font-normal text-3xl sm:text-4xl md:text-5xl xl:text-[54px] leading-tight xl:leading-[59px] bg-[linear-gradient(176.19deg,#B1D8FF_-8.19%,#FFFFFF_107.43%)] bg-clip-text text-transparent">{s1.title}</h2>
                        <p className="text-white/80 text-[15px] sm:text-[20px] leading-[30px] font-semibold my-5">{s1.subtitle}</p>
                        {s1.description && <p className="text-white/60 text-[14px] sm:text-[18px] leading-[22px] sm:leading-[27px] font-normal mb-5 2xl:pr-10">{s1.description}</p>}
                        <div className="flex flex-col gap-5 mb-8">
                            {s1.points.map((point, i) => (
                                <div key={i} className="flex items-center gap-3"><CheckIcon /><span className="text-white/60 text-[14px] sm:text-[18px] leading-[27px]">{point.text}</span></div>
                            ))}
                        </div>
                        <button className="w-fit bg-white text-black text-[18px] sm:text-[20px] leading-6 font-semibold px-5 h-[48px] sm:h-[52px] rounded-[16px] hover:bg-white/90 transition-colors cursor-pointer inline-flex items-center gap-2.5">
                            {s1.ctaText}
                ...
                {/* Card 3 — Volatility */}
                <div className='border border-[#FFFFFF0D] bg-[#FFFFFF05] px-6 sm:px-10 lg:pl-[90px] lg:pr-[74px] py-[70px] rounded-[40px] lg:rounded-[80px] flex flex-col lg:flex-row justify-between gap-8 lg:gap-6 items-center'>
                    <div className="flex flex-col max-w-full lg:max-w-[649px] w-full">
                        <div className="mb-5 w-fit bg-[#88C4FF1A] text-[#88C4FF] inline-flex items-center gap-2 pl-3.5 pr-[16px] py-[9px] rounded-[100px] text-[14px] sm:text-[18px] leading-5 sm:leading-[22px] font-normal font-inter">
                            <svg width="15" height="15" viewBox="0 0 15 15" fill="none"><circle cx="7.5" cy="7.5" r="7.5" fill="#88C4FF" /><circle cx="7.5" cy="7.5" r="5.5" fill="#21314F" /><circle cx="7.5" cy="7.5" r="3.5" fill="#88C4FF" /></svg>
                            {s2.badge}
                        </div>
                        <h2 className="tracking-[-1.62px] text-left font-normal text-3xl sm:text-4xl md:text-5xl xl:text-[54px] leading-tight xl:leading-[59px] bg-[linear-gradient(176.19deg,#B1D8FF_-8.19%,#FFFFFF_107.43%)] bg-clip-text text-transparent">{s2.title}</h2>
                        <p className="max-w-[500px] text-white/80 text-[15px] sm:text-[20px] leading-[30px] font-semibold my-5">{s2.subtitle}</p>
                        {s2.description && <p className="text-white/60 text-[14px] sm:text-[18px] leading-[22px] sm:leading-[27px] font-normal mb-5">{s2.description}</p>}
                        <div className="flex flex-col gap-5 mb-8">
                    ...
                    <div className="relative w-full lg:max-w-[712px] rounded-[30px] max-h-[636px] overflow-hidden flex-shrink-0">
                ...
                <div className='border border-[#FFFFFF0D] bg-[#FFFFFF05] px-6 sm:px-10 lg:pl-[88px] lg:pr-[63px] py-[32px] rounded-[40px] lg:rounded-[80px] flex flex-col lg:flex-row justify-between gap-8 lg:gap-6 items-center'>
                    <div className="relative w-full lg:max-w-[699px] max-h-[712px] rounded-[20px] overflow-hidden p-5 border border-[#FFFFFF14] flex-shrink-0">
                        <Image src={s3.image} alt={s3.imageAlt} width={659} height={673} className='object-contain' />
                    </div>
                    <div className="flex flex-col max-w-full lg:max-w-[615px] w-full">
                        <div className="mb-5 w-fit bg-[#88C4FF1A] text-[#88C4FF] inline-flex items-center gap-2 pl-3.5 pr-[16px] py-[9px] rounded-[100px] text-[14px] sm:text-[18px] leading-5 sm:leading-[22px] font-normal font-inter">
                            <svg width="15" height="15" viewBox="0 0 15 15" fill="none"><circle cx="7.5" cy="7.5" r="7.5" fill="#88C4FF" /><circle cx="7.5" cy="7.5" r="5.5" fill="#21314F" /><circle cx="7.5" cy="7.5" r="3.5" fill="#88C4FF" /></svg>
                        ...
                        <h2 className="max-w-[615px] text-left font-normal text-3xl sm:text-4xl md:text-5xl xl:text-[54px] leading-tight xl:leading-[59px] bg-[linear-gradient(176.19deg,#B1D8FF_-8.19%,#FFFFFF_107.43%)] bg-clip-text text-transparent">{s3.title}</h2>
                        <p className="text-white/80 text-[15px] sm:text-[20px] leading-[30px] font-semibold my-5">{s3.subtitle}</p>
                        {s3.description && <p className="text-white/60 text-[14px] sm:text-[18px] leading-[22px] sm:leading-[27px] font-normal mb-5">{s3.description}</p>}
                        <div className="flex flex-col gap-5 mb-8">
