...
const FEATURES: Feature[] = [
    ...
    },
    {
        ...
        icon: (
            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M15 27.5C21.2132 27.5 26.25 22.4632 26.25 16.25C26.25 10.0368 21.2132 5 15 5C8.7868 5 3.75 10.0368 3.75 16.25C3.75 22.4632 8.7868 27.5 15 27.5ZM15 10.3125C15.5178 10.3125 15.9375 10.7322 15.9375 11.25V16.25C15.9375 16.7678 15.5178 17.1875 15 17.1875C14.4822 17.1875 14.0625 16.7678 14.0625 16.25V11.25C14.0625 10.7322 14.4822 10.3125 15 10.3125Z" fill="#A288FF" />
                <path fill-rule="evenodd" clip-rule="evenodd" d="M11.5625 2.5C11.5625 1.98223 11.9822 1.5625 12.5 1.5625H17.5C18.0178 1.5625 18.4375 1.98223 18.4375 2.5C18.4375 3.01777 18.0178 3.4375 17.5 3.4375H12.5C11.9822 3.4375 11.5625 3.01777 11.5625 2.5Z" fill="#A288FF" />
            </svg>
        ),
