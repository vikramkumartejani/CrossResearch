...
function SmallCard({ card }: { card: typeof GRID_CARDS[0] }) {
    return (
        <div className="bg-[#16161F] flex flex-col cursor-pointer transition-colors">
            <div className="flex-1 bg-[#FFFFFF08] min-h-[199px] relative" >
                {card.tag && (
    ...
    return (
        <div>
            ...
            <div className="border-b border-[#FFFFFF0D] pb-6 mb-5 px-4 lg:px-6">
                ...
                <h1 className="text-white text-[35px] font-medium leading-[42px] mb-2">Playbooks</h1>
            ...
            <div className="px-4 lg:px-6">
                ...
                {/* Row 1: Featured (left) + 2×2 grid (right) */}
