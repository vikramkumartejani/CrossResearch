            ...
            <div className="border-b border-[#FFFFFF0D] pb-6 mb-5 px-4 lg:px-6">
                <div className="mb-3 flex items-center gap-1">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7.9987 14.6673C11.6806 14.6673 14.6654 11.6825 14.6654 8.00065C14.6654 4.31875 11.6806 1.33398 7.9987 1.33398C4.3168 1.33398 1.33203 4.31875 1.33203 8.00065C1.33203 11.6825 4.3168 14.6673 7.9987 14.6673Z" stroke="#838388" stroke-width="1.2" />
                        <path d="M6.33203 10.6673V5.33398" stroke="#838388" stroke-width="1.2" stroke-linecap="round" />
                        <path d="M7.33203 5.33333V4M8.9987 5.33333V4" stroke="#838388" stroke-width="1.2" stroke-linecap="round" />
                        <path d="M7.33203 11.9993V10.666M8.9987 11.9993V10.666" stroke="#838388" stroke-width="1.2" stroke-linecap="round" />
                        <path d="M6.33203 8H9.66536C10.2176 8 10.6654 8.44773 10.6654 9V9.66667C10.6654 10.2189 10.2176 10.6667 9.66536 10.6667H5.33203" stroke="#838388" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M5.33203 5.33398H9.66536C10.2176 5.33398 10.6654 5.7817 10.6654 6.33398V7.00065C10.6654 7.55292 10.2176 8.00065 9.66536 8.00065H6.33203" stroke="#838388" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
