        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="bg-[#16161F] p-4 flex flex-col">
                <div className="flex items-center justify-between">
                    <div>
                        <p className="text-[#838388] text-[14px] leading-[17px] mb-2">Vol Regime</p>
                ...
                <p className="mt-auto text-[#838388] text-[14px] leading-[20px] font-normal">
            ...
            <div className="bg-[#16161F] p-4">
                <div className="flex items-center justify-between mb-4">
                    <div>
                        <p className="text-[#838388] text-[14px] leading-[17px] mb-2">Liquidations</p>
                        <p className="text-white text-[18px] leading-[22px] font-medium">
                            Crypto Liquidation Zone
                        </p>
                    </div>
                    <span className="text-[#88C4FF] text-[14px] leading-[17px] font-medium">Magnet Zone</span>
                </div>

                <div className="flex flex-col gap-4">
                    {LIQ_ROWS.map((row) => (
                        <div key={row.price} className="flex items-center gap-4">
                            <span className="text-white/50 text-[14px] leading-[17px] font-medium w-16 flex-shrink-0">{row.price}</span>
                            <div className="flex-1 relative h-5 flex items-center bg-[#FFFFFF0D]">
                                <div
                                    className="h-full flex items-center px-2"
                                    style={{ width: `${row.width}%`, backgroundColor: row.color }}
                                >
                                    <span className={`text-[11px] leading-[13px] font-semibold whitespace-nowrap ${row.type === 'short' ? 'text-black' : 'text-white'}`}>{row.label}</span>
                                </div>
                            </div>
                            <span className="text-[#838388] text-[14px] leading-[17px] font-medium flex-shrink-0">$421M</span>
                        </div>
                    ))}
                </div>
                ...
                <div className="flex items-center gap-8 mt-4">
                    <div>
                        <p className="text-white/50 text-[14px] leading-[17px] font-medium">Total Shorts At Risk</p>
                        <p className="text-[#2CB37B] text-[16px] leading-[19px] font-semibold mt-1">$5412M (Above Spot)</p>
                    </div>
                    <div>
                        <p className="text-white/50 text-[14px] leading-[17px] font-medium">Total Longs At Risk</p>
                        <p className="text-[#E25C3F] text-[16px] leading-[19px] font-semibold mt-1">$4520M (Below Spot)</p>
                    </div>
                </div>
            </div>
        </div>
