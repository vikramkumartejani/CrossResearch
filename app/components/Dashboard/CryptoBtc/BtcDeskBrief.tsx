    ...
    return (
        <div className="bg-[#16161F] p-3 sm:p-5 flex flex-col h-full">
            ...
            <div>
                ...
                <div className="flex items-center gap-1 mt-1">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8 12.666V3.33268" stroke="#2CB37B" strokeWidth="1.16667" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M12.6654 8L7.9987 3.33333L3.33203 8" stroke="#2CB37B" strokeWidth="1.16667" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
            ...
            <div>
                ...
                <div className="flex items-center gap-1 mt-1">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8 3.33398V12.6673" stroke="#E25C3F" strokeWidth="1.16667" strokeLinecap="round" strokeLinejoin="round" />
                        <path d="M12.6654 8L7.9987 12.6667L3.33203 8" stroke="#E25C3F" strokeWidth="1.16667" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
