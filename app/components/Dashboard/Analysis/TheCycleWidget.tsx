...
/** Desk notes shown under the cycle metrics. Numbers are derived from array length (01, 02, …). */
  ...
  },
  {
    ...
    icon: (
      <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <path
          d="M18.3823 6.0581C17.6865 4.29179 16.2786 2.88392 14.5123 2.18808C13.191 1.66755 12 2.86452 12 4.28468V7.71325C12 8.18664 12.3838 8.5704 12.8571 8.5704H16.2857C17.7059 8.5704 18.9028 7.37943 18.3823 6.0581Z"
          fill="white"
        />
      </svg>
    ),
    ...
    icon: (
      <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M15.0004 2.35693C15.3555 2.35693 15.6433 2.64475 15.6433 2.99979V4.92836H17.5718C17.9269 4.92836 18.2147 5.21618 18.2147 5.57122C18.2147 5.92626 17.9269 6.21408 17.5718 6.21408H15.6433V8.14265C15.6433 8.49769 15.3555 8.7855 15.0004 8.7855C14.6454 8.7855 14.3576 8.49769 14.3576 8.14265V6.21408H12.429C12.0739 6.21408 11.7861 5.92626 11.7861 5.57122C11.7861 5.21618 12.0739 4.92836 12.429 4.92836H14.3576V2.99979C14.3576 2.64475 14.6454 2.35693 15.0004 2.35693Z"
          fill="white"
        />
        <path
          d="M1.71387 5.5715C1.71387 3.75322 1.71387 2.84409 2.27873 2.27922C2.8436 1.71436 3.75274 1.71436 5.57101 1.71436C7.38928 1.71436 8.29842 1.71436 8.86329 2.27922C9.42815 2.84409 9.42815 3.75322 9.42815 5.5715C9.42815 7.38977 9.42815 8.29891 8.86329 8.86378C8.29842 9.42864 7.38928 9.42864 5.57101 9.42864C3.75274 9.42864 2.8436 9.42864 2.27873 8.86378C1.71387 8.29891 1.71387 7.38977 1.71387 5.5715Z"
          fill="white"
        />
        <path
          d="M11.1426 15.0002C11.1426 13.1819 11.1426 12.2728 11.7074 11.7079C12.2723 11.1431 13.1814 11.1431 14.9997 11.1431C16.818 11.1431 17.7271 11.1431 18.292 11.7079C18.8569 12.2728 18.8569 13.1819 18.8569 15.0002C18.8569 16.8185 18.8569 17.7276 18.292 18.2925C17.7271 18.8574 16.818 18.8574 14.9997 18.8574C13.1814 18.8574 12.2723 18.8574 11.7074 18.2925C11.1426 17.7276 11.1426 16.8185 11.1426 15.0002Z"
          fill="white"
        />
        <path
          d="M1.71387 15.0002C1.71387 13.1819 1.71387 12.2728 2.27873 11.7079C2.8436 11.1431 3.75274 11.1431 5.57101 11.1431C7.38928 11.1431 8.29842 11.1431 8.86329 11.7079C9.42815 12.2728 9.42815 13.1819 9.42815 15.0002C9.42815 16.8185 9.42815 17.7276 8.86329 18.2925C8.29842 18.8574 7.38928 18.8574 5.57101 18.8574C3.75274 18.8574 2.8436 18.8574 2.27873 18.2925C1.71387 17.7276 1.71387 16.8185 1.71387 15.0002Z"
          fill="white"
        />
      </svg>
    ),
    ...
    value: (
      <span className="flex items-center gap-1">
        <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          />
          <path
            d="M15.0443 9.5L9.5026 15.0417L3.96094 9.5"
            stroke="#E25C3F"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
          ...
          {CYCLE_ITEMS.map((item) => (
            ...
            >
              ...
              <div>
                ...
                <p className={`text-[16px] font-semibold leading-[19px] mt-1 ${item.valueColor}`}>
        ...
        <div className="mt-2.5 sm:mt-4 bg-[#FFFFFF0D] border border-[#FFFFFF05] p-3.5 flex items-start h-fit flex-col gap-3">
          ...
          <div className="flex flex-col gap-2.5 sm:gap-3 w-full">
            {commentary.map((item, index) => (
              <div key={`${index}-${item.slice(0, 24)}`} className="flex gap-2 sm:gap-3 items-start">
                <span className="text-[#88C4FF] text-[13px] sm:text-[14px] leading-[17px] font-semibold flex-shrink-0 tabular-nums">
