    ...
    return (
        <div className="bg-[#16161F] p-3 sm:p-5 flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto">
                {EVENTS.map((ev, i) => (
                    <div key={i} className="border-b border-[#FFFFFF1A] pb-3 sm:pb-3.5 pt-3 sm:pt-3.5 first:pt-0 last:border-0">
                        <div className="flex items-start justify-between gap-2 mb-2">
                            <div className="flex flex-col sm:flex-row items-start gap-1 sm:gap-[20px] min-w-0">
                                ...
                                <p className="text-white text-[14px] sm:text-[16px] leading-[19px] font-semibold">{ev.title}</p>
                            </div>

                            <span className={`text-[12px] leading-[16px] font-semibold shrink-0 ${ev.badgeColor}`}>
                                {ev.badge}
                            </span>
                        </div>
            ...
            <div className="flex items-start gap-2">
                ...
                <p className="text-white/60 text-[12px] leading-4 sm:leading-[17px] font-normal">{FOOTER_NOTE}</p>
            </div>
        </div>
    )
}
