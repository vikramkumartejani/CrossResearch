...
export default function SectorGammaDashboard() {
    return (
        <div className="mb-5 bg-[#16161F] p-5 grow h-full">
            {/* Section heading */}
            <h2 className="text-white text-[18px] leading-[22px] font-medium mb-2">Sector Gamma Dashboard</h2>
            <p className="text-[#838388] text-[14px] leading-[17px] mb-4">Dealer concentration map net GEX in $B</p>

            {/* Sector grid */}
            <div className="mb-5">
                <div className="grid grid-cols-3 gap-3">
                    {SECTORS.map((sector) => (
                        <div key={sector.ticker} className="text-center bg-[#FFFFFF08] p-4 flex flex-col gap-5">
                            <div>
                            ...
                            <div>
                                <p
                                    className={`text-[18px] leading-[22px] font-bold mb-1 ${sector.positive ? 'text-[#2CB37B]' : 'text-[#E25C3F]'
                                        }`}
                                >
                                    {sector.value}
                                </p>
                                <p
                                    className={`text-[12px] leading-[14px] font-medium ${sector.positive ? 'text-[#2CB37B]' : 'text-[#E25C3F]'
                                        }`}
                                >
                                    {sector.label}
                                </p>
            ...
            <p className="text-white/50 text-[14px] leading-[20px] mb-5">{NARRATIVE}</p>
