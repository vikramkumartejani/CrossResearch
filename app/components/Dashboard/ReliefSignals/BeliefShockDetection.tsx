            ...
            <div className="flex flex-1 min-h-0">
                ...
                <div className="flex-1 flex flex-col min-w-0">
                    <svg width="474" height="158" viewBox="0 0 474 158" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g opacity="0.8">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M10 10V11L474 11V10L10 10Z" fill="white" fill-opacity="0.1" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M10 59V60L474 60V59L10 59Z" fill="white" fill-opacity="0.1" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M10 108V109L474 109V108L10 108Z" fill="white" fill-opacity="0.1" />
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M10 157V158L474 158V157L10 157Z" fill="white" fill-opacity="0.5" />
                        </g>
                        <rect x="10" y="123.521" width="461.969" height="34.4793" fill="url(#paint0_linear_584_5014)" />
                        <path d="M310.352 123.536H426.579C428.789 123.536 430.579 125.327 430.579 127.536V139.862C430.579 142.071 432.37 143.862 434.579 143.862H471.005" stroke="white" stroke-opacity="0.1" stroke-width="3" stroke-dasharray="6 6" />
                        ...
                        <g filter="url(#filter0_dd_584_5014)">
                            ...
                            <rect x="313" y="116.464" width="14" height="14" rx="7" stroke="#2A2A2A" stroke-width="2" />
                        </g>
                        <g filter="url(#filter1_dd_584_5014)">
                            <rect x="4" y="2" width="16" height="16" rx="8" fill="white" />
                            <rect x="5" y="3" width="14" height="14" rx="7" stroke="#2A2A2A" stroke-width="2" />
                        </g>
                        <defs>
