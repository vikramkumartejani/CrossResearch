...
const InvestorSupport = () => {
    return (
        <div className='px-4 sm:px-6 pt-[109px]'>
            <div className='max-w-[1560px] mx-auto'>
                ...
                <div className="flex flex-col gap-6">
                    {SUPPORT_ITEMS.map((item) => (
                        <div
                            key={item.id}
                            className="relative flex items-center justify-between gap-[70px] bg-[#FFFFFF08] border border-[#FFFFFF0D] rounded-[40px] p-10 overflow-hidden"
                        >
                            ...
                            {/* Left: icon + name */}
                            <div className="relative z-10 flex items-center gap-5 sm:gap-6 flex-shrink-0 w-full sm:w-[320px] lg:w-[600px]">
                                <div className="flex-shrink-0 w-14 h-14 sm:w-[70px] sm:h-[70px] rounded-full bg-[#FFFFFF08] border border-[#FFFFFF0D] flex items-center justify-center">
                                    {item.icon}
                                </div>
                                <h3 className="text-white text-[16px] sm:text-[30px] font-semibold leading-[48px]">
                                    {item.name}
                                </h3>
                            </div>

                            {/* Center: description */}
                            <p className="relative z-10 hidden sm:block text-white/70 text-[13px] sm:text-[18px] leading-[20px] sm:leading-[29px] font-normal flex-1">
                            ...
                            <div className="relative z-10 flex-shrink-0">
                                {item.cta ? (
                                    <button className="bg-white text-black font-inter text-[13px] sm:text-[18px] font-semibold px-5 sm:px-8 h-[60px] rounded-full hover:bg-white/90 transition-colors cursor-pointer whitespace-nowrap">
                                        {item.cta}
                                    </button>
                                ) : (
