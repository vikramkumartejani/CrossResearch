                ...
                <div className="relative bg-[#FFFFFF05] border border-[#FFFFFF0D] rounded-[40px] lg:rounded-[60px] xl:rounded-[80px] py-14 sm:py-16 xl:py-[80px] px-6 md:px-10 xl:px-[60px] overflow-hidden flex flex-col items-center text-center">
                    ...
                    <div className="relative z-10 flex flex-col items-center max-w-[800px]">
                        ...
                        <div className="flex gap-2.5 sm:gap-4 flex-wrap justify-center">
                            <Link
                                href="/signup"
                                className="sm:w-fit w-full bg-white text-black px-6 sm:px-8 py-2.5 sm:py-4 rounded-[100px] text-[16px] sm:text-[18px] font-medium inline-flex items-center justify-center gap-2 hover:bg-white/90 transition-colors cursor-pointer"
                            >
                                Start Now
                            ...
                            <CalendlyButton className="sm:w-fit w-full bg-transparent border border-white/20 text-white px-6 sm:px-8 py-2.5 sm:py-4 rounded-[100px] text-[16px] sm:text-[18px] font-medium inline-flex justify-center items-center gap-2 hover:bg-white/5 transition-colors cursor-pointer">
