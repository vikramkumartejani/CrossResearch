...
const TABS = [
    {
        ...
        image: '/assets/global-market-insights-right-image.png',
        icon: (
                    ...
                    {TABS.map((tab, i) => (
                        ...
                        >
                            {/* <Image
                                ...
                                priority={i === 0}
                            /> */}
                            <p className="text-white text-[14px] sm:text-[16px] font-semibold flex items-center justify-center h-full">{tab.title}</p>
                        </div>
                    ))}
                </div>
            </div>
